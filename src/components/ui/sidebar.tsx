...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className={cn("group peer hidden md:block text-card-foreground", variant === 'inset' && 'bg-background p-2 pr-0' )}
        data-state={state}
      ...
      >
        <div
          className={cn(
            ...
            variant === 'inset' ? 'w-0' : 'w-[--sidebar-width]',
        ...
        <div
          className={cn(
            ...
            variant === 'inset' && 'p-2 static',
            variant === "floating" && "p-2",
            
            variant === "sidebar" && "group-data-[side=left]:border-r group-data-[side=right]:border-l",

            'group-data-[collapsible=icon]:w-[var(--sidebar-width-icon)]',
            variant !== 'inset' && 'w-[var(--sidebar-width)]',
        ...
        >
          <div
            ...
            className={cn(
              ...
              (variant === "floating" || variant === 'inset') && "rounded-xl border shadow-sm",
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "bg-background",
        "peer-data-[variant=inset]:min-h-[calc(100svh-theme(spacing.4))] md:peer-data-[variant=inset]:m-2 md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-[calc(var(--sidebar-width-icon)+theme(spacing.2))] md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl",
        className
      )}
      {...props}
    />
